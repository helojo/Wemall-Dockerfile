...
#安装npm依赖包
RUN yum -u install https://kojipkgs.fedoraproject.org//packages/http-parser/2.7.1/3.el7/x86_64/http-parser-2.7.1-3.el7.x86_64.rpm
...
#安装软件
RUN yum install npm nginx node git wget openssh-server supervisor
